...
class Class(BaseModel):
    ...
    course = models.ForeignKey(Course, on_delete=models.CASCADE, verbose_name=_("Course"), db_index=True)
    instructors = models.ManyToManyField(User, limit_choices_to={'is_teacher': True}, verbose_name=_("Instructors"))
    schedule = models.CharField(max_length=100, verbose_name=_("Schedule"), db_index=True)
